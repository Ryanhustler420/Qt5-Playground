...
// If you need a real linked list, with guarantees of contant time insertion in the middle
// of the list and iterators to items rather then indexes, use QLinkedList.
